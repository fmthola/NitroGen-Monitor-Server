...
// The NitroGen monitor itself is a Tkinter desktop window, not a web app, so it
// is not driven here.
//
// Requirements:
...
//   SONAR_PROJECT_KEY        default nitrogen-monitor-server-bazzite
...
const KEY = process.env.SONAR_PROJECT_KEY || "nitrogen-monitor-server-bazzite";
